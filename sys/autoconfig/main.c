 ...
 * $Header: main.c,v 1.3 88/11/02 11:15:21 dvolodin Exp $
 * $Log:	main.c,v $
 * Revision 1.3  88/11/02  11:15:21  dvolodin
 * Обращение к странице в/в идет пословно.
 * 
