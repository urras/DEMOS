 ...
 *
 * $Log:	xp.c,v $
 * Revision 1.3  90/12/12  17:13:01  korotaev
 * Правки под ДВК (my and dw).
 * 
 * Revision 1.2  88/01/20  16:02:24  root
 * Введены изменения для работы с СМ5404. Бурков.
 * 
 * Revision 1.1  86/07/14  22:01:10  avg
 * Initial revision
 * 
 */
...
int	xptype = 0;		/* drive type; declared so we can patch */
