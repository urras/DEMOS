#ifndef _sys_tmreg_h_
#       define  _sys_tmreg_h_
...
/* ILC is now soft error because dumb SU controller indicates it
   in some damn spots (exm: when i/o op is active on the first drive
   and you select remote second drive, ILC error is occured!)
*/
#define TMER_HARD       (TMER_EOT|TMER_NXM)
#define TMER_SOFT       (TMER_ILC|TMER_CRE|TMER_PAE|TMER_BGL|TMER_RLE|TMER_BTE)
