...
#ifndef _sys_rxreg_h_
#       define _sys_rxreg_h_
...
/*
 * RX11 Command and Status Register (RX2CS)
 */
...
/*
 * RX11 control function bits (0-3 of RX2CS)
 */
...
/*
 * RX11 Error and Status Register (RX2ES) --
