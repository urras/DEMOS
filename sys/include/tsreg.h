#ifndef _sys_tsreg_h_
#       define  _sys_tsreg_h_
...
/* Bits in (UNIBUS) status register (tssr) */
#ifdef SM1425
...
#define TS_FATAL        0000016         /* fatal error (sumer all error) */

#ifdef SM1425
#define	TSSR_BITS	\
"\10\20SC\17-\16-\15RMR\14NXM\13NBA\12A17\11A16\10SSR\
\7OFL\6-\5-\4TC2\3TC1\2TC0\1-"
#else
#define	TSSR_BITS	\
...
#define TS_RBP  0001000         /* read data parity error */
#define	TS_UNC	0000002		/* uncorrectable data */
#define TS_PARER 000001         /* read data parity error */
#define	TSXS1_BITS	\
"\10\20DLT\17-\16-\15-\14-\13-\12-\11RBP\10-\9-\8-\7-\6-\5-\4-\3-\2UNC\1PARER"
#else
#define	TS_DLT	0100000		/* data late */
...
#ifdef SM1425
#define TS_OPM  0100000         /* operation attempted to move tape */
#define TS_XFS  0000200         /* extended features switch setting */
#define TS_FVL  0000077         /* firmware version level */
#define	TSXS2_BITS	\
"\10\20OPM\17-\16-\15-\14-\13-\12-\11-\10XFS\7-"
#else
#define TS_OPM  0100000         /* operation attempted to move tape */
...
#define	TSXS3_BITS	\
"\10\10-\7OPI\6REV\5-\4DCK\3-\2-\1RIB"
#else
...
#define TS_HSP  0100000         /* high speed */
#define TSXS4_BITS      \
"\10\20HSP"
#endif
...
#define TS_HDS          0000020         /* high density */
...
#define TS_SFORW        0000000         /* forward space record */
#define TS_SREV         0000400         /* reverse space record */
#define TS_SFORWF       0001000         /* forward space file */
#define TS_SREVF        0001400         /* reverse space file */
#define TS_REW          0002000         /* rewind */
#define TS_WEOF         0000001         /* write tape mark */
#define TS_OFFL         0000402         /* unload */
#define TS_SENSE        0000007         /* get status */
#ifdef SM1425
#define TS_INIT         0000003         /* initialization of device */
#endif

/* characteristics (world 4)*/
...
#ifdef SM1425
/* characteristics (world 4)*/
#define TS_HDSCHR 040   /* high density */
#endif
