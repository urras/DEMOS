/*
 * $Log:	rl.c,v $
 * Revision 22.3  90/11/12  19:12:30  root
 * Новые вещи для СМ1425 и перемещение include.
 * 
 * Revision 22.2  89/04/27  13:50:56  korotaev
 * Изменения связанные с небольшим перемещением каталогов и файлов
 * 
 * Revision 22.1  89/04/12  14:32:14  korotaev
 * "param.h" ==> <sys/param.h>
 * 
 * Revision 22.0  89/03/25  12:31:28  korotaev
 * Отсюда начинается версия 2.2
 * 
 * Revision 1.1  86/04/19  17:54:53  avg
 * Initial revision
 * 
 */
...
register struct buf *bp;
{
	...
	if (rl.type[minor(bp->b_dev)] < 0) {
		...
		if (ctr >= 8) {
			...
			/*
			 * HACK-- for the distribution binary,
