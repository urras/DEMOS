...
/* $Header: /usr/users/korotay/DEMOS_2.2/rcs/src/rcs/RCS/partime.c,v 1.4 1987/03/30 15:54:44 dvolodin Exp $" */

/* $Log: partime.c,v $
 * Revision 1.4  1987/03/30  15:54:44  dvolodin
 * Добавлен московский временной пояс.
 *
 * Revision 1.3  86/02/23  22:13:33  avg
 * Сделаны изменения для МНОС и для работы с U-кодом.
 * 
 * Revision 1.2  85/12/29  13:06:52  fox
 * *** empty log message ***
 * 
 * Revision 1.1  85/12/26  21:55:55  fox
...
TM_MON},
	...
	{"msk",          -180*60, TWTIME, TM_ZON},
	{"msd",          -180*60, TWTIME+TWDST, TM_ZON},
