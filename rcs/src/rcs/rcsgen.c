 ...
 * Исправлена ошибка, допущенная при предыдущем изменении.
 *
 * Revision 1.4  86/03/05  11:54:50  dvolodin
 * При запросе описания, если первая строчка описания пустая,
 * забывали выводить новое приглашение. Исправлено ( СОПЛЯ! ).
 *
