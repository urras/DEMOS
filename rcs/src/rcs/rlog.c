 ...
 */
static char rcsid[]=
"$Header: /usr/users/korotay/DEMOS_2.2/rcs/src/rcs/RCS/rlog.c,v 1.3 1986/02/23 22:22:16 avg Exp $";
/*****************************************************************************
...
/* $Log: rlog.c,v $
 * Revision 1.3  1986/02/23  22:22:16  avg
 * Сделаны изменения для МНОС и для работы с U-кодом.
 *
 * Revision 1.1  85/12/26  22:18:17  fox
 ...
 */
{
	...
	if((Delta->log = malloc(logsize)) == NULL ) {
		fprintf( stderr, "Not enough core: readdeltalog\n" );
		exit(100);
	}
