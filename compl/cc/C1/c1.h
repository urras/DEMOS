/*      $Header: c1.h,v 2.1 86/12/08 20:30:27 dmitry Exp $
 * C code generator header
 *
 *      $Log:	c1.h,v $
 * Revision 2.1  86/12/08  20:30:27  dmitry
...
#define RLABEL  114
#define STRASG  115
#define BYTEASG 132     /* Especially for PASCAL compiler - @VG */
#define FCON1   133     /* ------ / ------- */
#define STRSET  116
#define BDATA   200
#define PROG    202
...
#define SINIT   220
#define GLOBAL  221
#define C3BRANCH 222    /* for FORTRAN compiler */
#define XNAME   223     /* for @VG PASCAL compiler */
#define XBRANCH 224     /*  ----- / -----          */
...
char *outname( /* char* */ );
char *getblk( /* unsigned */ );
struct tnode *optim( /* struct tnode *atree */ );
short geti();       /* Correct sign expansion for 32bits systems */
struct optab *match();
struct tnode *pow2();
struct tnode *tnode();
struct tnode *sdelay();
