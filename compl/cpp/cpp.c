...
#include <ediag.h>
#endif
#define edia(x,y) ediag(x,y) /* Диагностики для pperror, ppwarn */
/*
 * C preprocessor
...
АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщьыьэюя";
        i=0;
        while (c= *p++) {
...
# if unix
#ifdef sun4
    dirs[nd++] = "/home/mellorn/zaitcev/d22/include";
#else
    dirs[nd++] = "/usr/include";
#endif
# endif
# if miss
    dirs[nd++] = "/LANGUAGES/C:INCLUDE";
# endif
# if gcos
    dirs[nd++] = "cc/include";
# endif
