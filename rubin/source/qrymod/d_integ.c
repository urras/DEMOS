...
#			ifdef xQTR3
			if (tTf(49,12))
				printf("d_integ: Start: Relation: keys %s \n",
				    Qt.qt_rangev[rv].rngvdesc->reldum.relid);
#			endif
...
#			ifdef xQTR3
			if (tTf(49,13))
				printf("d_integ: Agg: Relation: keys %s \n",
				    Qt.qt_rangev[rv].rngvdesc->reldum.relid);
#			endif
...
#			ifdef xQTR3
			if (tTf(49,14))
				printf("d_integ: Start: Before issue: keys %s \n",
				    Qt.qt_rangev[rv].rngvdesc->reldum.relid);
#			endif
...
#			ifdef xQTR3
			if (tTf(49,15))
				printf("d_integ: After issue: Relation: keys %s \n",
				    Qt.qt_rangev[rv].rngvdesc->reldum.relid);
#			endif
...
#			ifdef xQTR3
			if (tTf(49, 2))
				printf("d_integ: Relation: keys %s / %s\n",
				    inttup.intrelid, inttup.intrelowner);
#			endif
