...
# define                opDATE          17
# define                opTIME          18
# define                opNEXT          19      /* Работа с SERIAL */
# define                opLAST          20
# define                opINIT          21
...
# define		mdNETQRY	20	/* reserved for distr rubin */
# define		mdMOVEREL	21	/* reserved for distr rubin */
# define		mdPROT		22	/* extra info for permit def, to qrymod */
# define		mdINTEG		23	/* extra info for integrity def, to qrymod */
# define		mdDCREATE	24	/* reserved for distr rubin */
# define		mdWAITQRY	25	/* reserved for distr rubin */
# define		mdREMQM		26	/* remove permit integrity definition */
# define		mdDISTRIB	27	/* reserved for distr rubin */
...
# define	SITE		'S'		/* reserved for distr rubin */
