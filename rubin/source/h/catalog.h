...
**
**	relation and attribute catalogs are defined in rubin.h.
**
**	Version:
...
struct tree
{
	...
	tt_id   treeid;                 /* internal name of this tuple */
	tt_seq  treeseq;                /* sequence number in tree */
	tt_type treetype;               /* type info for this tree */
	char	treexxxx;
...
**	are bit maps.
** Типы согласованы с типами в setkey-s и с dbtmplt7
*/
