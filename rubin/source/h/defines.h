#
/*
**  RUBIN.H -- basic header file for rubin.
**
...
#define relfill relfree   /* Кортежей на лист, +1 для HASH */
...
struct tup_id
{
	char    ORDER(pg0,pg1,pg2,line_id);
};
#else
struct tup_id
{
...
/*
**	anytype union -- union of rubin types
*/
