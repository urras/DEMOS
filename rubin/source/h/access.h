...
/* Special value of mainpg == 0, if S_NOZERO */
# define        MAINZERO        (1<<31) /* Last bit in LONG */
...
# define        A_CYRCNV        0000100         /* Не делать русские файлы */
