...
**	compiling RUBIN you should eyeball this file to see
...
/*
**	USERRUBIN is the UNIX login name of the RUBIN superuser,
**		normally "rubin" of course.  The root of this persons
**		subtree as listed in /etc/passwd becomes the root of
**		the RUBIN subtree.
*/

# define	USERRUBIN	"rubin"
