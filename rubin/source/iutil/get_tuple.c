...
# include	<sccs.h>
/*
static char rcsid[]="$Header: get_tuple.c,v 1.2 87/11/26 14:52:39 rubin Exp $";
 */
/*
**      $Log:	get_tuple.c,v $
 * Revision 1.2  87/11/26  14:52:39  rubin
 * Исправлена упаковка/распаковка с учетом выравнивания
 * 
 * Revision 1.1  87/11/26  14:42:05  rubin
 * Initial revision
 * 
