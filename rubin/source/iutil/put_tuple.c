...
# include	<sccs.h>
/*
static char rcsid[]="$Header: put_tuple.c,v 1.2 87/11/26 14:53:18 rubin Exp $";
 */
/*
 *      $Log:	put_tuple.c,v $
 * Revision 1.2  87/11/26  14:53:18  rubin
 * Исправлена упаковка/распаковка с учетом выравнивания
 * 
 * Revision 1.1  87/11/26  14:42:13  rubin
 * Initial revision
 * 
 */
