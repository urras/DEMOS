...
**
**      ВНИМАНИЕ: Много ошибок по несовместивости ЭВМ связано с тем,
**      что если тип атрибута и тип значения должны СТРОГО совпадать на
**      иначе при нумерации байтов справа налево результат будет неверен
*/
