...
# define        YYDEBUG         0       /* must ALWAYS be on-used in yyparse()*/
...
# define        mdDECL          18      /* C - declaration */
# define        mdCTLELM        19      /* left hand side of target list element
					 * in "retrieve" to C-variables
					 */
# define        mdEXIT          20      /* ## exit */
# define        mdRUBIN         21      /* ## rubin */
# define        mdTUPRET        22      /* "retrieve" w/o an "into" */
# define        mdFILENAME      23      /* used in "copy" statement */
