...
# else
# define        DBUFSIZ         2000    /* size of buffer for dbu commands */
# define        TREEMAX         2000    /* max number of bytes for tree */
# define        MAXATT          100     /* max number of attributes in the att stash */
# endif
...
# define        BADDACHAR       2141
# define        BADTICHAR       2142
# define        BADTODATE       2143
# define        NEEDCHAR        2145    /* Аргемент д. быть строкой    */
# define        SERNONEG        2146    /* Variable must be positive */
# define        NEEDPOSINT      2147    /* 2-nd arg must be INT >= 0 */
