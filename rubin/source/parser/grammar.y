...
**  GRAMMAR.Y
**
**	This file contains a grammar for rubin parsing.  It is setup
**	for the (7-31-78) version of yacc.
**
**	Use:
**		to use for non-distributed rubin:
...
/* CONSTANTS */
%token          NAME    SCONST  I2CONST I4CONST F4CONST F8CONST DATECONST TIMECONST
...
attribfcn:	I2CONST =
	...
	|       DATECONST =
		{
			$$ = tree(NULL, NULL, DATE, 4, $1);
		}
	|       TIMECONST =
		{
			$$ = tree(NULL, NULL, TIME, 4, $1);
		}
	|	SCONST =
		{
			if (patmat($1) && !Qlflag)
