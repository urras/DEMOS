...
/* Character rtypes table and macro */
extern char Cmap[256];
#define CTYPE(c) Cmap[(c)&0377]
...
extern int    Opcode;     /* opcode for current token */
extern int    Lcase;      /* UPPER->lower conversion flag */
extern int    Pars;       /* flag for call to getcvar or not */
extern int    Newline;    /* set if last char read was a newline */
extern int    Cflag;      /* set if line of C-code recognized */
extern int    Keyent;     /* number of entries in the Keyword table */

extern char            Sbuf[SBUFSIZ];          /* symbol table buffer */
/*
