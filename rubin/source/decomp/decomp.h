...
# ifndef MICRO
# define MAXRELN	6		/* size of relation descriptor cache */
# define QBUFSIZ        1500            /* buffer size (bytes) of original query tree */
# define SQSIZ          6000           /* buffer size for tree copies + sub-queries */
# define AGBUFSIZ       300             /* buffer size for temp agg tree components */
# define PBUFSIZE	500		/* size of parameter buffer area for setp() */
# define PARGSIZE	PV_MAXPC	/* max number of arguments for setp() */
# define N_DBUFS        6
# else
# define MAXRELN        4               /* size of relation descriptor cache */
# define QBUFSIZ        1200            /* buffer size (bytes) of original query tree */
# define SQSIZ          2500           /* buffer size for tree copies + sub-queries */
# define AGBUFSIZ       250             /* buffer size for temp agg tree components */
# define PBUFSIZE       400             /* size of parameter buffer area for setp() */
# define PARGSIZE	PV_MAXPC	/* max number of arguments for setp() */
# define N_DBUFS        2
# endif
#endif
