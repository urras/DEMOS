...
char            QbnameQUEL[30];     /* pathname of query buffer */
char            QbnameSQL[30];     /* pathname of query buffer */
char           *Qbname;
extern char	*Fileset;	/* unique string */
extern char	*Pathname;	/* pathname of RUBIN root */
...
/* query buffer stuff */
FILE            *Qryiop,*QryiopQUEL,*QryiopSQL;        /* the query buffer */
char		Newline;	/* set if last character was a newline */

extern  int     Sql;            /* 1, если текущий язык SQL */
extern  int     SQL_flag;       /* 1, если SQL есть в принципе */
/* other stuff */
