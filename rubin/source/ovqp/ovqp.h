...
# define	SERNOLAST	4115	/*variable in SER_LAST undefined */
# define	SERNODEF	4116	/*Variable in ser_next undefined */
# define        SERNONEG        4117    /* Variable must be positive     */
...
extern FAR aop_interp();
extern FAR relop_interp();
extern SYMBOL *FAR interpret();
extern FAR typecheck();
extern FAR typecoerce();
extern FAR i2toi4();
extern FAR i4toi2();
extern FAR itof();
extern FAR ftoi2();
