/*
 * $Log:	clock.c,v $
 * Revision 1.2  90/02/21  16:05:25  rygoff
 * На Э-85 real-time-clock'а нет,
 * поэтому нечего и проверять на каждом тике
 * 
 * Revision 1.1  90/02/21  15:47:14  rygoff
 * Initial revision
 * 
 * Revision 1.4  88/07/15  16:39:26  alex
 * Вставлена переменная timеclk для работы режима DO_ESCAPE
 * в терминальном драйвере (ttynew.c).
 * 
