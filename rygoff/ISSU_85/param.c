...
#include        "video.h"
#if    NVI > 0
#define HZ      16      /* У Электроники-85 такая частота */
#else
...
#   endif
#else   UCB_CLIST
#       define NCLIST    80             /* number of clists */
#endif  UCB_CLIST

#define NPROC   18 /* This is very few, but OK for Э-85 (without 2nd tty) */
...
#define NDISK   2                       /* number of disks to monitor */
