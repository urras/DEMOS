 ...
 *
 * $Log:	config.c,v $
 * Revision 1.4  90/09/13  13:18:55  ache
 ...
 * Изменена таблица общеизвестных сетевых имен, добавлен NOXSTR у rcsid.
 * 
...
/*NOXSTR*/
static char rcsid[] = "$Header: config.c,v 1.4 90/09/13 13:18:55 ache Exp $";
/*YESXSTR*/
