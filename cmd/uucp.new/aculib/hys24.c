...
#ifdef HAYES2400
/*
 *      hys24popn(telno, flds, dev) connect to hayes smartmodem (pulse call)
 *      hys24topn(telno, flds, dev) connect to hayes smartmodem (tone call)
 *	char *flds[], *dev[];
 *
 *	return codes:
 *		>0  -  file number  -  ok
