 ...
 *
 * $Log: fmt.c,v $
 * Revision 1.7  1991/01/19  15:25:54  ache
 * -- <ediag.h>
 *
 * Revision 1.6  90/12/07  16:43:59  avg
 * dOBAWLENA PROCEDURA panic
 * 
 * Revision 1.5  90/09/29  18:22:39  ache
 * <ctype.h> kicked out...
 * 
 * Revision 1.4  90/04/20  22:08:26  avg
 * *** empty log message ***
 * 
 * Revision 1.3  88/07/23  20:33:30  ache
 * rUSSKIE DIAGNOSTIKI
 * 
 * Revision 1.2  88/01/11  12:41:28  avg
 * dOBAWLEN NOXSTR U rcsid.
 * 
 * Revision 1.1  87/12/25  15:59:21  avg
 * Initial revision
 * 
 */

/*NOXSTR
static char rcsid[] = "$Header: /usr/src/Relcom/relcom/mailx/RCS/fmt.c,v 1.7 1991/01/19 15:25:54 ache Exp $";
YESXSTR*/
...
int     width = 60;             /* Width that we will not exceed */
...
"fmt:  kON^ILASX OPERATIWNAQ PAMQTX\n"));
		exit(1);
	}
	copy(str, top);
	return(top);
