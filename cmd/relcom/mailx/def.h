 ...
 * Port to Borland C
 *
 * Revision 1.17  1991/07/19  20:00:14  ache
 ...
 * oPISANIE SENDMAIL WYNESENO W OTDELXNYJ FAJL.
 *
...
/*
 * $Header: /usr/src/Relcom/relcom/mailx/RCS/def.h,v 1.18 1991/07/22 16:36:47 ache Exp $
 */
...
#ifdef  MSDOS
#ifdef	__TURBOC__
#define SIGQUIT SIGILL	/* Nothing fansy */
...
#define GNGR    64              /* And Newsgroups: line */
#define GNEWS   128             /* And News lines */
#define GMASK   (GTO|GSUBJECT|GCC|GBCC|GREFS|GADD|GNGR|GNEWS)
				/* Mask of places from whence */

#define GNL     256             /* Print blank line after */
#define GDEL    512             /* Entity removed from list */
#define GCOMMA  1024            /* detract puts in commas */
...
struct header {
	...
	char    *h_newsgroups;          /* Newsgroups list */
	char    *h_keywords;            /* News keywords list */
	char    *h_summary;             /* News summary */
	char    *h_distribution;        /* News distribution region */
