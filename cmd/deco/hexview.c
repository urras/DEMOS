...
static viewhhead (), viewhline (), viewhpage (), prhline (), hsearch ();
extern char *getstring (), *strcpy ();
extern long lseek ();

hexview (filename)                              /* hexadecimal viewer */
char *filename;
{
	register baseline;
	register char *p;
...
static viewhhead (filename, line)
char *filename;
{
	register i;
