...
/*
 * Характеристики терминала из /etc/termcap.
 */
...
/*
 * Псевдо-функции для работы со стандартным окном.
 */
...
/*
 * Псевдо-фынкции установки режимов работы с окном.
 */
...
/*
 * Псевдо-фынкции установки режимов работы терминала.
 */
