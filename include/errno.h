...
#define EHOSTUNREACH    66              /* No route to host */
	...
	/* IPC errors */
#define EIDRM           ESHUTDOWN       /* группа разделяемого ресурса удалена */
#define ENOMSG          ENXIO           /* нет подходящих сообщений */

#define ENOTEMPTY       EMLINK          /* удаляемый каталог не пуст */
