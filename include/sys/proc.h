...
# include <sys/localopts.h>     /* define VIRUS_VFORK etc */
...
/* #ifdef  UCB_METER     Для того, чтобы не изменять ps, pstat*/
...
#define p_quant p_time
#define p_sflag p_cpu
#define p_level p_pri
#define p_baslev p_nice
