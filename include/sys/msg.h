...
#define MSG_OOB         020000  /* out of band package */
...
struct msqid_ds {
	...
	u_short          msg_lspid;      /* pid of last msgsnd */
	u_short          msg_lrpid;      /* pid of last msgrcv */
...
struct msg {
	...
	short           msg_spot;       /* message text map address (clicks) */
};
...
struct msginfo {
	...
	u_short  msgseg; /* # of msg segments (MUST BE < 32768) */
};
